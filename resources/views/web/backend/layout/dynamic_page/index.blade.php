    ...
    <div class="content-wrapper">
        <div class="row">
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Dynamic Page List</h4>
                        <div style="display: flex;justify-content: end;">
                            <a href="{{ route('admin.dynamic_page.create') }}" class="btn btn-primary">Add Dynamic Page</a>
                        </div>
...
@push('script')
    ...
    <script>
        ...
        function statusChange(id) {
            var url = '{{ route('admin.dynamic_page.status', ':id') }}';
            $.ajax({
                type: "GET",
                url: url.replace(':id', id),
