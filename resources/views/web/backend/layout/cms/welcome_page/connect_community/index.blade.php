    ...
    <div class="content-wrapper">
        <div class="row">
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Connect Community List</h4>
                        <div style="display: flex;justify-content: end;">
                            <a href="{{ route('admin.connect_community.create') }}" class="btn btn-primary">Add Connect Community</a>
                        </div>
...
@push('script')
    ...
    <script>
        $(document).ready(function() {
            ...
            if (!$.fn.DataTable.isDataTable('#data-table')) {
                let dTable = $('#data-table').DataTable({
                    ...
                    ajax: {
                        url: "{{ route('admin.connect_community.index') }}",
                        type: "get",
                    },
        ...
        const deleteAuction = (id) => {
            try {
                let url = '{{ route('admin.connect_community.destroy', ':id') }}';
        ...
        function statusChange(id) {
            var url = '{{ route('admin.connect_community.status', ':id') }}';
            $.ajax({
                type: "GET",
                url: url.replace(':id', id),
