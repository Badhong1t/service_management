...
@section('content')
    ...
    <main class="h-[calc(100vh-96px)] flex flex-col items-center justify-center mx-5 md:mx-8 2xl:mx-0">
        <!-- Login Form -->
        <section
            ...
            <div class="mt-2 md:mt-4">
                <form class="space-y-3 md:space-y-5" action="{{ route('sendOtp') }}" method="POST">
                    @csrf
                    <div>
                        <input required
        ...
        <section
            class="mt-4 md:mt-6 font-poppins p-4 w-full md:p-6 rounded-lg md:rounded-l-xl lg:rounded-2xl shadow-[0px_6px_16px_0px_rgba(20,20,20,0.15)] sm:max-w-[500px] sm:min-w-[500px] text-sm md:text-base">
            <div class="w-full text-center">
                <p>
                    Have an account?
                    <a href="{{route('login')}}" class="font-semibold underline">Log in</a> now.
                </p>
            </div>
        </section>
    </main>
