...
@section('content')
    ...
    <main class="min-h-[calc(100vh-96px)] flex flex-col items-center justify-center font-poppins mx-5 md:mx-8 2xl:mx-0">
        ...
        <section
            ...
            <div class="mt-4">
                <form action="{{ route('post.businessInformation') }}" method="post" class="space-y-3 md:space-y-5"
                    ...
                    <div class="space-y-4">
                        <div class="w-full">
                            <input
                                ...
                                placeholder="Business Name" type="text" name="businessName" id="businessName"
                        ...
                        <div class=" w-full">
                            <select class="text-sm md:text-base" id="category" name="category">
                        ...
                        <div class="w-full">
                            <input
                                class="w-full py-4 px-6 rounded-md bg-[#E5E5E5] text-sm font-poppins focus:outline-none text-[#2E2E2E] placeholder:text-[#2E2E2E]"
                                placeholder="License Number(If any)" type="number" name="licenseNumber" id="licenseNumber"
                        ...
                        <div class="w-full">
                            <div
                                ...
                                <input type="file" class="hidden" name="businessPhoto" id="businessPhoto" />
                            ...
                            <div>
                                <p class="mt-4 text-[#2E2E2E] text-xs md:text-sm text-center">Please upload your business
                                    documents to continue</p>
                                @error('businessPhoto')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
