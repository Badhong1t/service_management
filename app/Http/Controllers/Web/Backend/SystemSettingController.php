...
class SystemSettingController extends Controller
{
    ...
    public function update(Request $request)
    {
        ...
        try {
            ...
            $setting->logo = uploadImage($request->file('logo'),'system/logo', $setting->logo);
            $setting->favicon = uploadImage($request->file('favicon'),'system/favicon', $setting->favicon);
    ...
    {
        return view('web.backend.layout.system_setting.stripe');
    }
    ...
    {
        return view('web.backend.layout.system_setting.paypal');
    }
